...
<header class="p-3 text-bg-dark">
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      <a href="/kino" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
        <img src="" alt="KINO" class="bi me-2" width="40" height="32" role="img" aria-label="KINO">
      </a>
      ...
      <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
        <input style="color: red;" type="search" class="form-control form-control-dark text-bg-dark" placeholder="Pesquisar..." aria-label="Search">
      </form>
