        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h5>Do Bom Kino</h5>
                    <p>Transformando a Experiência Gastronômica em Luanda</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="/images/back (6).png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="/images/back (5).png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
